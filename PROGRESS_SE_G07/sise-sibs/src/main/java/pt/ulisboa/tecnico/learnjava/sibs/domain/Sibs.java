...
public class Sibs {
	...
	public void transfer(String sourceIban, String targetIban, int amount)
		...
		TransferOperation operation = (TransferOperation) this
				.getOperation(this.addOperation(Operation.OPERATION_TRANSFER, sourceIban, targetIban, amount));
	...
	public int addOperation(String type, String sourceIban, String targetIban, int value)
		...
		this.operations[position] = this.operation;
		return position;
	}
